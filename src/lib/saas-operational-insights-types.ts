...
export interface OperationalInsightsDiscoveryMarket {
  language: string;
  locale: string;
  market_label: string;
  notes: string;
  ...
  query_seeds?: string[];
  is_anchor_market?: boolean;
  is_priority_buildout_market?: boolean;
}
...
export interface OperationalInsights {
  ...
  discovery_market_distribution_model: string;
  discovery_market_claim_rule: string;
  discovery_anchor_markets: string[];
  discovery_proven_markets: OperationalInsightsDiscoveryMarket[];
  discovery_priority_buildout_markets: OperationalInsightsDiscoveryMarket[];
  discovery_watchlist_markets: OperationalInsightsDiscoveryMarket[];
...
export const EMPTY_OPERATIONAL_INSIGHTS: OperationalInsights = {
  ...
  discovery_market_distribution_model: "",
  discovery_market_claim_rule: "",
  discovery_anchor_markets: [],
  discovery_proven_markets: [],
  discovery_priority_buildout_markets: [],
  discovery_watchlist_markets: [],
